...
function Suggestion({ suggestion, launch_time, difficulty }: SuggestionProps) {
    return (<Card className="filter brightness-50 outline-2 outline border-none bg-geo-someotherfuckignshadeofgrey p-4 outline-geo-light  hover:filter-none hover:outline-geo-teal hover:brightness-100">
        <h2 className="text-white font-medium pb-2">
            {suggestion}
        </h2>
